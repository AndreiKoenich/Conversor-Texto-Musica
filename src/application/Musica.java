...
public class Musica {
	...
	/* Atributos contendo os dados iniciais da música a ser reproduzida. */
	...
	/* Os quatro métodos abaixo são usados para não permitir valores incorretos para os atributos da música sendo reproduzida. */
